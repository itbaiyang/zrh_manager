...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        ...
        '<span>{{ item }}</span>' +
        '</li>' +
        '<li ng-show="conf.currentPage < conf.numberOfPages" ng-click="nextPage()"><span>下一页</span></li>' +
        '<li ng-show="conf.currentPage < conf.numberOfPages" ng-click="lastPage()"><span>尾页</span></li>' +
        '共<strong style="color: #f88694">{{ conf.numberOfPages }}</strong>页' +
        '&nbsp;&nbsp;第<input type="text" class="pagerInput" style="margin: 0 3px" ng-model="jumpPageNum"  />页 ' +
        '<button class="btn skipBarBtn" style="margin-left:10px" ng-click="jumpToPage($event)">确定</button>' +
        ...
        link: function(scope, element, attrs){
            ...
            function getPagination(newValue, oldValue) {
                ...
                // numberOfPages
                scope.conf.numberOfPages = Math.ceil(scope.conf.totalItems / 20);
            ...
            scope.jumpToPage = function(){
                if (scope.conf.currentPage != scope.jumpPageNum) {
